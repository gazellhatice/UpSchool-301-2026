...
import 'package:kisisel_harcama_kocu_1/features/auth/presentation/widgets/auth_brand_panel.dart';
...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final formMaxWidth = wide ? 440.0 : (size.width > 520 ? 440.0 : double.infinity);
          ...
          child: SingleChildScrollView(
            ...
            child: ConstrainedBox(
              constraints: BoxConstraints(
                ...
                maxWidth: wide ? 1000 : formMaxWidth,
              ),
              child: wide
                  ? Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: formMaxWidth, child: formColumn),
                      ],
                    )
                  : formColumn,
            ),
